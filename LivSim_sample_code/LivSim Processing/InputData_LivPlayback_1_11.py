...
PatientPlayback = nump.loadtxt("data/Patients.txt")
print("Patients.txt loaded.")

#Organ Input Data
OrganPlayback = nump.loadtxt("data/Donors.txt")
print("Donors.txt loaded.")

#Progession Input Data
ProgressionPlayback = nump.loadtxt("data/Status.txt")
print("Status.txt loaded.")

#Relist Data
Relist = nump.loadtxt("data/Input_Relist.txt")
print("Input_Relist.txt loaded.")

#Acceptance Model Data
AcceptanceModel = nump.loadtxt("data/Input_Acceptance.txt")
print("Input_Acceptance.txt loaded.")

AcceptanceModelS1 = nump.loadtxt("data/Input_Acceptance_Status1.txt")
print("Input_Acceptance_Status1.txt loaded.")

DSA_Avg_Times = nump.loadtxt("data/DSA_AvgTimes.txt")
...
with open("data/Donor_Accept.txt",'r') as inputf:
...
with open("data/Patients_Accept.txt",'r') as inputf:
    reader = list(csv.reader(inputf, delimiter = '|'))
    Patients_Accept = []
    for row in reader:
...
if i_initial ==1:
    ...
    InitialList = nump.loadtxt("data/Waitlist_matchmeld.txt")
