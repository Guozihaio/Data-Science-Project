...
import entity
import event
import InputData_LivPlayback_1_11
...
if __name__ == "__main__":
  ...
  for reps in range(1, nreps+1):
      ...
      OPTN = deepcopy(InputData_LivPlayback_1_11.OPTN_initial)	
      ...
      subset_PatientPlayback = InputData_LivPlayback_1_11.PatientPlayback[InputData_LivPlayback_1_11.PatientPlayback[:,0] == reps]
      subset_OrganPlayback = InputData_LivPlayback_1_11.OrganPlayback[InputData_LivPlayback_1_11.OrganPlayback[:,0] == reps]
      subset_ProgressionPlayback = InputData_LivPlayback_1_11.ProgressionPlayback[InputData_LivPlayback_1_11.ProgressionPlayback[:,0] == reps]	
      ...
      while Calendar != []:
          ...
          # if next event is an organ arrival, call organ arrival function to allocate organ
              ...
              Sim.clock = nextevent.time
              Sim, Stat, OPTN = event.OrganArrival(nextevent.info, Sim, Stat, OPTN, InputData_LivPlayback_1_11.Regions, InputData_LivPlayback_1_11.SharingPartners, InputData_LivPlayback_1_11.Patients_Accept, InputData_LivPlayback_1_11.Donor_Accept, InputData_LivPlayback_1_11.DSA_Avg_Times, InputData_LivPlayback_1_11.AcceptanceModelS1, InputData_LivPlayback_1_11.AcceptanceModel, InputData_LivPlayback_1_11.Relist, reps)	
